 ...
 <tr>
  <td>
   <table bgcolor="#000000" cellspacing="1" cellpadding="2" border="0">
    ...
    <? $sortlink="videoprod.php?order="; ?>
    <tr bgcolor="#224488">
     <th colspan="9" align="center">video prods</td>
     </th>
     </tr>
     <tr bgcolor="#224488">
     <th>
...
<?			
   	...
   	for($j=0;$j<count($prods);$j++) {
		...
		print("<br /></a></td><td><img src=\"gfx/z.gif\" width=\"2\" height=\"1\" border=\"0\"><br /></td><td nowrap><a href=\"prod.php?which=".$prods[$j]["id"]."\">".strtolower(htmlentities(stripslashes($prods[$j]["name"])))."</a> (<a href=\"".$prods[$j]["link"]."\">video</a>)<br /></td><td>&nbsp;</td>");
