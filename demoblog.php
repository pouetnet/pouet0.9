		 ...
		 <td>
			...
			elseif($avg_rating==0)
			 ...
			 <img src="<?=$thumbgfx?>" width="16" height="16" border="0" alt="." align="left">&nbsp;<?=$avg_rating?><br>
       		...
       		<tr>
		 <td><b>[</b><a href="user.php?who=<? print($who);?>">glopper view</a><b>]</b><br /></td><td><b>[</b><a href="demoblog.php?who=<? print($who);?>&nothumbsdown=1&nopiggies=1">recommendations only</a><b>]</b> <b>[</b><a href="demoblog.php?who=<? print($who);?>&nothumbsup=1&nopiggies=1">kaka taste</a><b>]</b> <b>[</b><a href="demoblog.php?who=<? print($who);?>&nothumbsup=0&nopiggies=0&nothumbsdown=0">all comments</a><b>]<br /></td>
       		</tr>
	   </table>
	</td>
